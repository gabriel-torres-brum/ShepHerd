...
<form method="POST"
   ...
   <div class="grid gap-6 mb-6 lg:grid-cols-2">
      ...
      <div>
         ...
         <input class="input input-bordered input-primary w-full text-neutral bg-slate-50 dark:bg-slate-200"
            type="date" id="data_nascimento" value="{{ $pessoa->data_nascimento }}" name="data_nascimento">
      </div>
      <div>
         ...
         <select class="select select-bordered select-primary w-full text-neutral bg-slate-50 dark:bg-slate-200" value="{{ old("estado_civil_id") }}" name="estado_civil_id"
            ...
            <option @if($estadoCivil->id == $pessoa->estado_civil_id) selected @endif value="{{ $estadoCivil->id }}">{{ $estadoCivil->estado_civil }}</option>
            @endforeach
         </select>
      </div>
   </div>
   ...
   <div class="grid gap-6 mb-6 lg:grid-cols-2">
      <div>
         ...
         <input class="input input-bordered input-primary rounded-md w-full text-neutral bg-slate-50 dark:bg-slate-200" type="text"
            id="nome_pai" value="{{ $pessoa->nome_pai }}" name="nome_pai">
      </div>
      <div>
         <label class="label" for="nome_mae">Nome da mãe</label>
         <input class="input input-bordered input-primary rounded-md w-full text-neutral bg-slate-50 dark:bg-slate-200" type="text"
            id="nome_mae" value="{{ $pessoa->nome_mae }}" name="nome_mae">
      </div>
   </div>
   ...
   <div class="grid gap-6 mb-6 lg:grid-cols-2">
      <div>
         ...
         <input class="input input-bordered input-primary rounded-md w-full text-neutral bg-slate-50 dark:bg-slate-200" type="text"
            id="igreja_origem" value="{{ $pessoa->igreja_origem }}" name="igreja_origem">
      </div>
      <div>
         <label class="label" for="cargo_id">Cargo</label>
         <select class="select select-bordered select-primary w-full text-neutral bg-slate-50 dark:bg-slate-200" value="{{ $pessoa->cargo_id }}" name="cargo_id"
            id="cargo_id">
      ...
      <div>
         ...
         <select class="select select-bordered select-primary w-full text-neutral bg-slate-50 dark:bg-slate-200" value="{{ $pessoa->dizimista }}" name="dizimista"
            id="dizimista">
      ...
      <div>
         ...
         <select class="select select-bordered select-primary w-full text-neutral bg-slate-50 dark:bg-slate-200" value="{{ $pessoa->batizado }}" name="batizado"
            id="batizado">
            <option value="0">Não</option>
            <option value="1">Sim</option>
         </select>
      ...
      <div>
         ...
         <input class="input input-bordered input-primary rounded-md w-full text-neutral bg-slate-50 dark:bg-slate-200" type="date"
            id="data_batismo" value="{{ $pessoa->data_batismo }}" name="data_batismo">
      </div>
   </div>
