...
<form class="w-full max-w-sm text-base px-6" action="{{ route('register.handle') }}" method="POST">
    <p class="font-semibold text-sm text-slate-600 mt-3 mb-6">Informe suas credenciais para se registrar</p>
    @csrf
    <div class="flex flex-col font-semibold space-y-4">
        <div class="flex flex-col space-y-2">
            <label class="text-left text-sky-800" for="name">Nome completo</label>
            <input class="outline-none p-1.5 rounded ring-2 ring-stone-500/40 focus:ring-sky-600/50 pl-2 text-sm"
            ...
            <input class="outline-none p-1.5 rounded ring-2 ring-stone-500/40 focus:ring-sky-600/50 pl-2"
        ...
        <div class="flex text-sm">
            <p class="text-stone-800 pr-1">Já tem cadastro?</p><a class="text-cyan-600 hover:text-cyan-400 transition"
