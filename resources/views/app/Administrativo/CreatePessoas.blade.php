...
<form method="POST"
   ...
   action="{{ route('administrativo.pessoas.handleCreate') }}">
   @method('PUT')
   @csrf
   ...
   <div class="grid gap-6 mb-6 lg:grid-cols-2">
      <div>
         ...
         <input class="form-input rounded-md w-full text-neutral bg-slate-50 dark:bg-slate-200" type="text" id="nome"
            value="{{ old("nome") }}" name="nome">
      </div>
      <div>
         <label class="label" for="data_nascimento">Data de Nascimento</label>
         <input class="form-input rounded-lg input-bordered w-full text-neutral bg-slate-50 dark:bg-slate-200"
      ...
      <div>
         ...
         <select class="form-select rounded-md w-full text-neutral bg-slate-50 dark:bg-slate-200" value="{{ old("estado_civil_id") }}" name="estado_civil_id"
            id="estado_civil_id">
            @foreach ($civil as $estadoCivil)
   ...
   <div class="grid gap-6 mb-6 lg:grid-cols-2">
      <div>
         ...
         <input class="form-input rounded-md w-full text-neutral bg-slate-50 dark:bg-slate-200" type="text"
   ...
   <div class="grid gap-6 mb-6 lg:grid-cols-2">
      ...
      <div>
         ...
         <select class="form-select rounded-md w-full text-neutral bg-slate-50 dark:bg-slate-200" value="{{ old("cargo_id") }}" name="cargo_id"
            id="cargo_id">
      ...
      <div>
         ...
         <select class="form-select rounded-md w-full text-neutral bg-slate-50 dark:bg-slate-200" value="{{ old("dizimista") }}" name="dizimista"
            id="dizimista">
      ...
      <div>
         ...
         <select class="form-select rounded-md w-full text-neutral bg-slate-50 dark:bg-slate-200" value="{{ old("batizado") }}" name="batizado"
            id="batizado">
            <option value="0">Não</option>
            <option value="1">Sim</option>
         </select>
      ...
      <div>
         ...
         <input class="form-input rounded-md w-full text-neutral bg-slate-50 dark:bg-slate-200" type="date"
